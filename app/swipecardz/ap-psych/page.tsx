...
export const metadata: Metadata = {
  title: "SwipeCardz - AP Psychology Flashcards That Stick",
  description:
    "Study smarter for AP Psychology with SwipeCardz. Import from Google Sheets, swipe to learn, and track your progress.",
};

export default function SwipeCardzAPPsychPage() {
  return (
      ...
      <div className="flex-1 max-w-6xl mx-auto px-4 sm:px-6 py-10 sm:py-8 w-full">
        <div className="flex flex-col items-center text-center mb-8 sm:mb-6">
          ...
          <h1 className="text-3xl sm:text-5xl font-bold text-gray-900 tracking-tight max-w-2xl">
            Study these AP Psych Terms as Swipeable Flashcards
          </h1>
